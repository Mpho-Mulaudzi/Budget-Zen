...
public class HmsRewardAd {
    ...
    private ReportUrlListener reportUrlListener;
    ...
    void setReportUrlListener(ReportUrlListener reportUrlListener) {
        this.reportUrlListener = reportUrlListener;
    }
    ...
    public void sendBiddingSuccess(Map<String, Object> sendSuccessInfo, ReportUrlListener r) {
        rewardAdInstance.sendBiddingSuccess(sendSuccessInfo, r);
    }

    public void sendBiddingFailed(Map<String, Object> sendFailedInfo, ReportUrlListener r) {
        rewardAdInstance.sendBiddingFailed(sendFailedInfo, r);
    }
    ...
    static class RewardAdReportUrlListener implements ReportUrlListener {
        private final Context context;

        HmsRewardAd hmsRewardAd;

        RewardAdReportUrlListener(Context context, HmsRewardAd hmsRewardAd) {
            this.context = context;
        ...
        public void reportSuccess() {
            ...
            HMSLogger.getInstance(context).sendSingleEvent("reportSuccess", "String.valueOf(errorCode)");
        }

        @Override
        public void reportFailed(String s, int i) {
            HMSLogger.getInstance(context).startMethodExecutionTimer("reportFailed");
            HMSLogger.getInstance(context).sendSingleEvent("reportFailed", "String.valueOf(errorCode)");
        }
    }
