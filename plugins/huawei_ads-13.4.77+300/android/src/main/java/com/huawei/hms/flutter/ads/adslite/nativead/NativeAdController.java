    ...
    public void onMethodCall(final MethodCall call, @NonNull MethodChannel.Result result) {
        switch (call.method) {
            case "sendBiddingFailed":
                ...
                nativeAd.sendBiddingFailed(someMap, this.reportUrlListener);
                break;
            case "sendBiddingSuccess":

                HMSLogger.getInstance(context).startMethodExecutionTimer("sendBiddingSuccess");
                Map<String, Object> myMap = (Map<String, Object>) call.arguments;

                nativeAd.sendBiddingSuccess(myMap, this.reportUrlListener);
                break;
            case "setup":
            ...
            case "getBiddingInfo":
                ...
                if (biddingInfo == null) {
                    ...
                    Log.i(TAG, "bidding info is null");
                } else {
