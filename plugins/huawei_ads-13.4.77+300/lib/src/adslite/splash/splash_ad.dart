...
class SplashAd {
  ...
  Future<String> sendBiddingSuccess() async {
    return await Ads.instance.channelSplash.invokeMethod("sendBiddingSuccess");
  }

  /// Returns real-time bidding data.
  Future<BiddingInfo?> getBiddingInfo() async {
    return BiddingInfo.fromJson(await Ads.instance.channelSplash.invokeMethod(
      'getBiddingInfo',
    ));
  }
