...
class RewardAd {
  ...
  Future<BiddingInfo?> getBiddingInfo() async {
    return BiddingInfo.fromJson(await Ads.instance.channelReward.invokeMethod(
      'getBiddingInfo',
    ));
  }

  Future<void> sendBiddingSuccess(Map<dynamic, dynamic> sendSuccessInfo) async {
    print('flutter sendBiddingSuccess');
    await Ads.instance.channelReward
        .invokeMethod('sendBiddingSuccess', sendSuccessInfo);
  }

  Future<void> sendBiddingFailed(Map<dynamic, dynamic> sendFailInfo) async {
    await Ads.instance.channelReward
        .invokeMethod('sendBiddingFailed', sendFailInfo);
  }
