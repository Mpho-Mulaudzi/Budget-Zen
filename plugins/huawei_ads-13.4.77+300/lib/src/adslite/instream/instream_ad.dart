...
class InstreamAd {
  ...
  Future<dynamic> sendBiddingSuccess() async {
    return await _channel.invokeMethod("sendBiddingSuccess");
  }

  Future<dynamic> sendBiddingFailed() async {
    return await _channel.invokeMethod("sendBiddingFailed");
  }

  /// Returns real-time bidding data.
  Future<BiddingInfo?> getBiddingInfo() async {
    return BiddingInfo.fromJson(await _channel.invokeMethod(
      'getBiddingInfo',
    ));
  }
